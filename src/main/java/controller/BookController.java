...
public class BookController {
    ...
    public String index(Model model, String book_name, Integer book_type, Integer is_borrow, Integer curPage) {
        if (curPage == null) {
            curPage = 1;
        }
        ...
        List<Book> bookList = bookService.all(book_name, is_borrow, book_type, curPage, 5);
